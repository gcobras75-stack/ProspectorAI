...
import { loadLastAnalysis, getMuestras, saveProjectChatHistory, loadProjectState, loadProjectWaypoints } from '../core/Database';
...
export default function GeologoScreen() {
  ...
  // Keep analysis points for nearest-cell context
