        ...
        <ScrollView style={[styles.content, { maxHeight: '100%', flex: 1, backgroundColor: '#000', borderColor: '#FFD700', borderWidth: 2, padding: 20, borderRadius: 20 }, isFieldMode && styles.contentLight]}>
          ...
          {!sampleBase64 ? (
            <View style={{ marginTop: 20 }}>
              <Text style={{ color: isFieldMode ? '#444' : '#888', fontSize: 14, marginBottom: 15 }}>
            ...
            <View style={{ marginTop: 10 }}>
              ...
              {aiResult && (
                <View style={[{ backgroundColor: '#222', padding: 15, borderRadius: 8, marginBottom: 15, borderWidth: 1, borderColor: '#FFD700' }, isFieldMode && { backgroundColor: '#FFFFFF', borderColor: '#000000', borderWidth: 3 }]}>
                  ...
                  <Text style={[{ color: '#FFF', fontSize: 13, marginTop: 2 }, isFieldMode && { color: '#000' }]}>{aiResult.alteracion}</Text>
                  <Text style={{ color: '#AAA', fontSize: 11, marginTop: 10, letterSpacing: 1 }}>INDICADORES CLAVE</Text>
                  <Text style={[{ color: '#FFF', fontSize: 13, marginTop: 2 }, isFieldMode && { color: '#000' }]}>{aiResult.indicadores?.join(', ')}</Text>
                  ...
                  <Text style={[{ color: '#DDD', fontSize: 13, lineHeight: 18, marginTop: 2 }, isFieldMode && { color: '#000' }]}>{aiResult.analisis_detallado}</Text>
...
const styles = StyleSheet.create({
  ...
  sub: { color: '#AAA', fontSize: 14, marginBottom: 15 },
  ...
  btnOutlineRed: { flex: 1, minWidth: 100, backgroundColor: 'transparent', paddingVertical: 10, paddingHorizontal: 16, borderRadius: 8, borderWidth: 2, borderColor: '#FF3B30', alignItems: 'center' },
  btnOutlineGold: { flex: 1, minWidth: 100, backgroundColor: 'transparent', paddingVertical: 10, paddingHorizontal: 16, borderRadius: 8, borderWidth: 2, borderColor: '#FFD700', alignItems: 'center' },
  btnGold: { flex: 1, minWidth: 100, backgroundColor: '#FFD700', paddingVertical: 10, paddingHorizontal: 16, borderRadius: 8, borderWidth: 2, borderColor: '#000', alignItems: 'center' },
